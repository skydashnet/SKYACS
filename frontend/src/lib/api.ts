...
export interface ProvisioningRule { id: number; parameter_name: string; parameter_value: string; parameter_type: string; manufacturer: string; product_class: string; enabled: boolean; description: string }
